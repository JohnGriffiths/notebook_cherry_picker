...
class CherryPickingPreprocessor(Preprocessor):
    ...
    keeptags = Unicode('html pdf slides', config=True, help="kepp tags expression.")
    ...
    def preprocess(self, nb, resources):
        ...
        for worksheet in nb.worksheets:
            ...
            for index, cell in enumerate(worksheet.cells):
              ...
              kt = self.keeptags
              keepit=True
              if 'cell_tags' not in cm: 
                if 'html' in kt or 'pdf' in kt or 'slides' in kt: keepit=False
              else: 
                if 'html' in cm['cell_tags']:
                  if 'html' in self.keeptags and cm['cell_tags']['html'] is False: keepit=False
                if 'pdf' in cm['cell_tags']:
                  if 'pdf' in self.keeptags and cm['cell_tags']['pdf'] is False: keepit=False
                if 'slides' in cm['cell_tags']:
                  if 'slides' in self.keeptags and cm['cell_tags']['slides'] is False: keepit=False
